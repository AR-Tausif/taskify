...
const TaskBox = ({ openModal, setOpenModal, tsk }) => {
  ...
  return (
    ...
    //         <RiPieChart2Fill />
    //       </p>
    //       <p className="font-semibold">{tsk}</p>
    //     </div>
    //     <div
    //       className={`opacity-0 absolute ${
    //         show && "opacity-100"
    //       } space-x-2 bg-sky-100 p-1 transition-all top-0 left-60 w-2/6`}
    //     >
    //       <Tooltip radius="none" content="Edit" id="editable">
    //         <button className="p-1  border hover:bg-sky-50 transition-all">
    //           <RiEdit2Line />
    //         </button>
    //       </Tooltip>
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <p className="font-semibold text-[1rem]">{tsk}</p>
      </div>
      <div
        className={`opacity-0 absolute ${
          show && "opacity-100"
