  ...
  return (
    ...
    <div className="flex w-full flex-col md:w-1/2">
      <div className="flex justify-center pt-12 md:-mb-24 md:justify-start md:pl-12">
        <a href="/main" className="border-b-gray-700 border-b-4 pb-2 text-2xl font-bold text-gray-900"> Taskfiy . </a>
      </div>
      <div className="lg:w-[28rem] mx-auto my-auto flex flex-col justify-center pt-8 md:justify-start md:px-6 md:pt-0">
        ...
        <div className="py-12 text-center">
          <p className="whitespace-nowrap text-gray-600">
            ...
            <NavLink to="/register" className="underline-offset-4 font-semibold text-gray-900 underline">Sign up for free.</NavLink>
          </p>
        </div>
      </div>
    </div>
